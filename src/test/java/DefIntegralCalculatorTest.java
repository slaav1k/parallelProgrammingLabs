...
public class DefIntegralCalculatorTest {
    ...
    @Test
    public void testCalculateOneInterval() {
        // Тест с одним интервалом разбиения
        DefIntegralCalculator calculator = new DefIntegralCalculator(0, 1, 1);
        double result = calculator.calculate();
        assertEquals(0.301268, result, 0.000001);  // Точность до 6 знаков
    }
