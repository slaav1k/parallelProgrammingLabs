...
public class DefIntegralCalculator {
     ...
     * @param resultStorage - хранилище для подсчета итераций
     * @throws IllegalArgumentException если количество интервалов <= 0 или если a > b
     */
    public DefIntegralCalculator(double a, double b, int n, IResultStorage resultStorage) {
        if (n <= 0) {
    ...
    public double calculate() {
        ...
        for (int i = 0; i < this.n; i++) {
            ...
            resultStorage.incrementIterations();
        }
